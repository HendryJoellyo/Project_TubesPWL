...
return new class extends Migration
{
    ...
    {   
       ...
       // Buat Tabel Roles terlebih dahulu (taruh sebelum tabel users)
Schema::create('roles', function (Blueprint $table) {
    $table->id();
    $table->string('name')->unique(); // Contoh: 'admin', 'mahasiswa', dll
    $table->timestamps();
});

// Kemudian ubah pembuatan tabel users:
Schema::create('users', function (Blueprint $table) {
    $table->id();
    $table->string('name');
    $table->string('email')->unique();
    $table->string('password');
    // Hapus enum role, ganti dengan foreign key role_id
